...
export default function PrimaryButton({ text, target, color = "var(--accent)" }: PrimaryButtonProps) {
    return (
        <Link
            href={target}
            className="overflow-hidden relative rounded-2xl w-full sm:h-40 h-50 border flex justify-center items-center text-white hover:text-black z-30 transition-all ease-in-out duration-300 border-[#C8FF00] bg-transparent hover:bg-[#C8FF00]"
        >
